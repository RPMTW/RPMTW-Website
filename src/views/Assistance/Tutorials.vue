<template>
  <div id="Tutorials">
    ...
    <div>
      ...
      <h3>
        選擇版本之後應該會出現類似下圖的介面，接下來介紹一下這些功能有什麼用處吧!
      </h3>
      <div class="img-infos">
        <strong>
          <li>
            <span class="orange">資料夾選擇：</span
            >可以選擇你想要翻譯的模組或版本檔案
          </li>
          <li>
            <span class="orange">搜尋字串：</span>這裡可以搜尋你想要查詢的字串
          </li>
          <li>
            <span class="orange">字串檢視介面：</span
            >通常預設他會先顯示尚未翻譯的字串，可以從這邊選擇想要翻譯的
          </li>
          <li><span class="orange">原始字串：</span>這裡會顯示文字的原文</li>
          <li>
            <span class="orange">語系鍵：</span
            >這裡會顯示該文字所屬的位置，可以參考用
          </li>
          <li>
            <span class="orange">翻譯後字串：</span
            >可以將翻譯完成後的文字填寫在這裡
          </li>
          <li>
            <span class="orange">儲存按鈕：</span
            >輸入完成翻譯的文字後，記得按下那個按鈕就會儲存翻譯
          </li>
          <li>
            <span class="orange">功能區：</span
            >裡面有四個按鈕可以方便翻譯使用，分別是
            評論區、查詢翻譯紀錄、查詢詞彙/維基百科、雜項功能
          </li>
        </strong>
      </div>
      <img
